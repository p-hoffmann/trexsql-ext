...
MAIN_SERVICE_PATH = f"{REPO_ROOT}/plugins/runtime/main/index.ts"
EVENT_WORKER_PATH = f"{REPO_ROOT}/plugins/runtime/event-worker/index.ts"
...
def test_swarm_register_trexas(node_factory):
    ...
    assert trexas_rows[0][4] == "running"
