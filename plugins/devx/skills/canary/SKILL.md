---
name: canary
aliases: ["canary", "smoke-test", "health-check"]
version: 1.0.0
description: |
...
use BrowserNavigate, BrowserClick tools -i -a -o ".gstack/canary-reports/baselines/<page-name>.png"
...
use BrowserNavigate, BrowserClick tools links
...
```bash
use BrowserNavigate, BrowserClick tools <page-url>
use BrowserNavigate, BrowserClick tools -i -a -o ".gstack/canary-reports/screenshots/pre-<page-name>.png"
use BrowserNavigate, BrowserClick tools console --errors
use BrowserNavigate, BrowserClick tools
```
...
```bash
use BrowserNavigate, BrowserClick tools <page-url>
use BrowserNavigate, BrowserClick tools -i -a -o ".gstack/canary-reports/screenshots/<page-name>-<check-number>.png"
use BrowserNavigate, BrowserClick tools console --errors
use BrowserNavigate, BrowserClick tools
```
