...
static void register_scalar_alias(duckdb_connection connection, const char *alias,
    duckdb_scalar_function_t func_ptr, int nparams) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, alias);
    ...
    duckdb_scalar_function_set_function(function, func_ptr);
...
void RegisterCirceHelloFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_hello");
...
void RegisterCirceOpenSSLVersionFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_openssl_version");
...
void RegisterCirceJsonToSqlFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_json_to_sql");
    ...
    register_scalar_alias(connection, "circe_json_to_sql", CirceJsonToSqlFunction, 2);
}

void RegisterCirceSqlRenderFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_sql_render");
...
void RegisterCirceSqlTranslateFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_sql_translate");
...
void RegisterCirceSqlRenderTranslateFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_sql_render_translate");
    ...
    // Deprecated alias for external consumers
    register_scalar_alias(connection, "circe_sql_render_translate", CirceSqlRenderTranslateFunction, 3);
}

void RegisterCirceGenerateAndTranslateFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_generate_and_translate");
...
void RegisterCirceCheckCohortFunction(duckdb_connection connection) {
    duckdb_scalar_function function = duckdb_create_scalar_function();
    duckdb_scalar_function_set_name(function, "trex_atlas_check_cohort");
    ...
    // Deprecated alias for external consumers
    register_scalar_alias(connection, "circe_check_cohort", CirceCheckCohortFunction, 1);
}
